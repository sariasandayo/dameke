...
(function () {
  ...
  function init() {
    ...
    el.attackerSelect.value = 'ジュペッタ'; el.defenderSelect.value = 'サーフゴー'; applyMoveFilter(); el.moveSelect.value = 'シャドークロー'; setTypeDefaults('attacker'); setTypeDefaults('defender');
